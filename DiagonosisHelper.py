...
#        master.minsize(700,350)
    ...
    def createWidget(self):
        ...
        self.btnStart = Button(self, text="Start Diagnosis",width=12,bg="bisque", command=self.btnStart_Click)
...
class MainForm(Frame):
    def __init__(self, master=None):
        ...
        master.title("HealthBot")
        self.create_widgets()

    def create_widgets(self):
        self.lblMsg=Label(self, text="HEALTHCARE CHATBOT", bg="lightgreen", width="280", height="2", font=("Helvetica 13 bold"))
        self.lblMsg.pack()
        
        Button(self, text="START DIAGNOSIS", bg="lightblue",
              font=("Helvetica", 14), 
              command=self.start_diagnosis).pack(pady=20)
        
        Label(self, text="Engineered by Favour I. Olowofeso", 
              bg="khaki", font=("Helvetica", 12)).pack(pady=10)
        
        Label(self, text="For EVERYONE", 
              bg="white", font=("Calibri", 12)).pack()

    def start_diagnosis(self):
        self.pack_forget()
        QuestionDigonosis(self.master).pack()
